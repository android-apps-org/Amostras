...
public class VisualizerView extends View {
    ...
    // constants that determine how much of a percentage of audio frequencies each shape represents
    // i.e. bass circle represents bottom 10% of frequencies
    ...
    // minimum size of shape by default before scaling
    private static final float MIN_SIZE_DEFAULT = 50;

    // multiplier is used to make frequency jumps a little more visually pronounced
    ...
    // controls size of circle each shape makes
    ...
    // array which keeps current fft bytes
    private byte[] mBytes;

    // time when animation started
    private long mStartTime;

    // represents current average of all values in bass, mid, and treble range in fft
    private float bass;
    private float mid;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        // setup all view measurement code after view is laid out
        // if this is done any earlier the height and width are not yet determined
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // get current angle all of the shapes are at
        ...
        // invalidate view to immediately redraw
        invalidate();
    }

    /**
     * Calculates, based on current time, the angle all of the shapes should be at
     *
    ...
    /**
     * Called by {@link AudioInputReader} class to pass in the current fast Fourier transform bytes
    ...
    /**
     * Set visibility of mid-range square
     *
    ...
    /**
     * Set visibility of treble triangle
     *
    ...
    /**
     * Set scale for minimum size of shape
     *
    ...
    /**
     * Set color of visualization
     * This should be one of the preference color values
     *
     * @param newColorKey
     */
