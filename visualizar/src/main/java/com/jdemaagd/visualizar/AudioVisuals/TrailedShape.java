...
/**
 * Abstract class representing a shape and a trail for where its been
 */
abstract class TrailedShape {

    // static variables for center of parent view and minimum size of all of shapes
    private static float sViewCenterX, sViewCenterY;
    private static float sMinSize;

    // variable for determining size
    ...
    /**
     * Abstracts out what is common between drawing all shapes
     *
    ...
    protected abstract void drawThisShape(
            float shapeCenterX, float shapeCenterY, float currentSize, Canvas canvas, Paint paint);
    ...
    /**
     * Sets shapes distance from center of view
     *
    ...
    /**
     * Inner class representing points in trail
     */
